...
const usersNewRouter = require('./routes/users-new/users-new-router')
const authRouter = require('./routes/auth/auth-router')
const authNewRouter = require('./routes/auth-new/auth-new-router')
...
const smsRouter = require('./routes/sms/sms-router')
...
app.use('/api/sign-up-new', usersNewRouter)

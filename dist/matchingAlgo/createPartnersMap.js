...
const createPartnersMap = ({ allRoundsDataForOnlineUsers, userIds, eventId }) => {
    ...
    //   return {}
    // }
    const roundsFromThisEvent = allRoundsDataForOnlineUsers.filter((round) => round.event_id === eventId);
...
exports.default = createPartnersMap;
//# sourceMappingURL=createPartnersMap.js.map
...
const getPredeterminedPartners = ({ userIds, eventId }) => __awaiter(void 0, void 0, void 0, function* () {
    let partnersListResponse;
    try {
        partnersListResponse = yield orm_1.default.request(queries_1.getPredeterminedPartnersFromListOfUserIds, {
            userIds,
            eventId,
        });
    }
...
exports.default = getPredeterminedPartners;
//# sourceMappingURL=getPredeterminedPartners.js.map